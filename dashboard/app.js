  ...
  <div class="stock-card ${cc}" style="animation-delay:${index*0.06}s"
    ...
    <div class="price-grid">
      <div class="price-item">
        <div class="price-item-label">Morning Open</div>
...
function openModal(index) {
  ...
  document.getElementById("modal-content").innerHTML = `
    ...
    <div class="modal-prices">
      <div class="modal-price-box"><div class="modal-price-label">Morning Open</div><div class="modal-price-val">₹${fmt(live.open_price || pick.current_price)}</div></div>
